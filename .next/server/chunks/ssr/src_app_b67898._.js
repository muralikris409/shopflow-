...
const ProductView = ({ product = {} })=>{
    ...
    const handleAddToCart = async ()=>{
        ...
        try {
            if (isLoggedIn) {
                ...
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$_service$2f$GuestCartService$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["addProduct"])(product);
    ...
    const handleAddorRemoveFromWishlist = async ()=>{
        ...
        try {
            const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$_service$2f$WishListService$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["addOrRemoveProductFromWishlist"])(isLoggedIn.id, id, token);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        if (id) {
            async function loadProduct() {
                try {
                    const product = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$_service$2f$ProductService$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getProductByID"])(id);
...
//# sourceMappingURL=src_app_b67898._.js.map