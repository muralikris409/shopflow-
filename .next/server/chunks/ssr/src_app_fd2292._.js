...
async function addOrRemoveProductFromWishlist(productId, token) {
    try {
...
function Product({ productId = 1 }) {
    ...
    const isLoggedIn = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$redux$2f$dist$2f$react$2d$redux$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useSelector"])((state)=>state.userData?.user);
    const token = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$redux$2f$dist$2f$react$2d$redux$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useSelector"])((state)=>state.userData?.token);
    ...
    const handleAddorRemoveFromWishlist = async ()=>{
        ...
        console.log(product);
        try {
            const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$_service$2f$WishListService$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["addOrRemoveProductFromWishlist"])(product.id, token);
...
//# sourceMappingURL=src_app_fd2292._.js.map