...
function Product({ productId = 1 }) {
    ...
    const handleBuy = async ()=>{
        ...
        try {
            ...
            const order = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$_service$2f$OrderService$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createOrder"])(items);
