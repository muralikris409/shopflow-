(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_16d34a._.js", {
...
"[project]/src/app/(application)/cartv2/page.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$shadcn$2f$ui$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/node_modules/@shadcn/ui/dist/index.js [app-client] (ecmascript)"); // Importing from shadcn
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$redux$2f$dist$2f$react$2d$redux$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/node_modules/react-redux/dist/react-redux.mjs [app-client] (ecmascript)");
...
const Cart = ()=>{
        ...
        "Cart.useEffect": ()=>{
            const loadCart = {
                "Cart.useEffect.loadCart": async ()=>{
                    if (isLoggedIn) {
                        dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$_lib$2f$cartReducer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchData"])(`/user/cart/viewCart?userId=${cookie?.user?.id}`, cookie?.token));
                    } else {
                        ...
                        dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$_lib$2f$cartReducer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchData"])({
                            items: guestCart,
                            totalAmount: guestCart.reduce({
                                "Cart.useEffect.loadCart": (acc, item)=>acc + item.offerPrice * item.quantity
                            }["Cart.useEffect.loadCart"], 0)
                        }));
                    }
                }
    ...
    const handleCheckout = async ()=>{
        ...
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$shadcn$2f$ui$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error('Failed to create order. Please try again.'); // Updated to shadcn toast
        } finally{
    ...
    const handleIncreaseQuantity = async (productId)=>{
        try {
            ...
            dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$_lib$2f$cartReducer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchData"])(isLoggedIn ? `/user/cart/viewCart?userId=${cookie?.user?.id}` : (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$_service$2f$GuestCartService$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getCart"])(), cookie?.token));
        } catch (err) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$shadcn$2f$ui$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error('Failed to update item quantity.'); // Updated to shadcn toast
        }
    };
    ...
    const handleRemoveProduct = async (productId)=>{
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$shadcn$2f$ui$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error('Failed to remove product from cart.'); // Updated to shadcn toast
        }
    };
...
_s(Cart, "U2p6ftFavRvkSvTODK0SFyML9E0=", false, function() {
    return [
...
function CartTile({ handleNavigation, product, onIncreaseQuantity, onDecreaseQuantity, onRemoveProduct, quantity }) {
    ...
    const handleOperation = async (operation, productId)=>{
        ...
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$shadcn$2f$ui$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error('Operation failed. Please try again.'); // Updated to shadcn toast
        } finally{
...
"[project]/src/app/(application)/cartv2/page.js [app-rsc] (ecmascript, Next.js server component, client modules)": ((__turbopack_context__) => {
...
//# sourceMappingURL=src_16d34a._.js.map