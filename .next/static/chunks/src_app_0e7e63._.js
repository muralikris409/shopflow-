(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_app_0e7e63._.js", {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$_service$2f$ProductService$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/src/app/_service/ProductService.js [app-client] (ecmascript)"); // Adjust the import path as necessary
        ...
        "SimilarProducts.useEffect": ()=>{
            const fetchProducts = {
                "SimilarProducts.useEffect.fetchProducts": async ()=>{
                    try {
                        const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$_service$2f$ProductService$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["subCategoryProducts"])(subCategoryId);
...
"[project]/src/app/_lib/toast.js [app-client] (ecmascript)": (function(__turbopack_context__) {
...
throw e;}}),
"[project]/src/app/(application)/product/[id]/Product.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$_components$2f$SimilarProducts$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/src/app/_components/SimilarProducts.js [app-client] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/node_modules/next/navigation.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$_lib$2f$utilReducer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/src/app/_lib/utilReducer.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$_lib$2f$toast$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/src/app/_lib/toast.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$redux$2f$dist$2f$react$2d$redux$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/node_modules/react-redux/dist/react-redux.mjs [app-client] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$bolt$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Bolt$3e$__ = __turbopack_import__("[project]/node_modules/lucide-react/dist/esm/icons/bolt.js [app-client] (ecmascript) <export default as Bolt>");
...
function Product({ productId = 1 }) {
    ...
    const isLoggedIn = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$redux$2f$dist$2f$react$2d$redux$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSelector"])({
        "Product.useSelector[isLoggedIn]": (state)=>state.session.user
    }["Product.useSelector[isLoggedIn]"]);
    const token = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$redux$2f$dist$2f$react$2d$redux$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSelector"])({
        "Product.useSelector[token]": (state)=>state.session.token
    }["Product.useSelector[token]"]);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Product.useEffect": ()=>{
            dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$_lib$2f$productReducer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchData"])(`/products/getProductById?productId=${productId}`));
        }
    }["Product.useEffect"], [
        dispatch,
        productId
    ...
    const handleBuy = async ()=>{
        ...
        try {
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$_lib$2f$toast$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])('Order created successfully! Redirecting to checkout...', 'success');
            handleNavigation(order);
        } catch (err) {
            console.error('Order creation failed:', err);
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$_lib$2f$toast$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])('Failed to create order. Please try again.', 'error');
        } finally{
            setLoadingState((prev)=>({
                    ...prev,
                    buy: false
    ...
    const handleAddToCart = async ()=>{
        ...
        try {
            if (isLoggedIn) {
                ...
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$_lib$2f$toast$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(response.message || 'Product added to your cart!', 'success');
            } else {
                // Handle guest cart logic here
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$_lib$2f$toast$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])('Product added to your guest cart!', 'success');
            }
        } catch (error) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$_lib$2f$toast$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])('An unexpected error occurred. Please try again.', 'error');
    ...
    const handleAddorRemoveFromWishlist = async ()=>{
        ...
        try {
            const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$_service$2f$WishListService$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addOrRemoveProductFromWishlist"])(isLoggedIn.id, product.id, token);
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$_lib$2f$toast$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(response?.data?.message || "Product added to Wishlist", 'success');
        } catch (error) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$_lib$2f$toast$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])('An unexpected error occurred. Please try again.', 'error');
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        onClick: isLoggedIn ? handleBuy : ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$_lib$2f$toast$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])('Please log in to buy.', 'error'),
                                        ...
                                        children: loadingState.buy ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        ...
                                        children: loadingState.cart ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                            className: "animate-pulse",
                                            children: "Loading..."
                                        }, void 0, false, {
                                            fileName: "[project]/src/app/(application)/product/[id]/Product.js",
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        ...
                                        children: loadingState.wishlist ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                            className: "animate-pulse",
                                            children: "Loading..."
                                        }, void 0, false, {
                                            fileName: "[project]/src/app/(application)/product/[id]/Product.js",
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$_components$2f$SimilarProducts$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
...
_s(Product, "08m+eUWs3otLNN62xWPkDQoSjts=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$redux$2f$dist$2f$react$2d$redux$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useDispatch"],
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"],
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$redux$2f$dist$2f$react$2d$redux$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSelector"],
...
"[project]/src/app/(application)/product/[id]/page.js [app-rsc] (ecmascript, Next.js server component, client modules)": ((__turbopack_context__) => {
...
//# sourceMappingURL=src_app_0e7e63._.js.map