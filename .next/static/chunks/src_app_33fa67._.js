(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_app_33fa67._.js", {
...
const UserProfile = ()=>{
    _s();
    const { user, loading, error, token } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$redux$2f$dist$2f$react$2d$redux$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSelector"])({
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "UserProfile.useEffect": ()=>{
            const fetchProfileInfo = {
                "UserProfile.useEffect.fetchProfileInfo": async ()=>{
                    try {
                        const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$_service$2f$UserService$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getProfileInfo"])(token, userId);
                        setProfileData(response.data.data);
                    } catch (err) {
                        console.error(err);
                    }
                }
            }["UserProfile.useEffect.fetchProfileInfo"];
            if (userId && token) {
                fetchProfileInfo();
            }
        }
...
_s(UserProfile, "jjdZyczIi6ClKtJlFBbJIBsxmtE=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$redux$2f$dist$2f$react$2d$redux$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSelector"]
    ];
});
...
//# sourceMappingURL=src_app_33fa67._.js.map