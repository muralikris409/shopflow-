(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_b9d6e6._.js", {

"[project]/src/app/_service/PaymentService.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const failedVerify = async (orderId)=>{
    ...
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$api$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["axiosInstance"].post(`/user/order/failedPayment?orderId=${orderId}`);
        return response.data;
    } catch (error) {
...
"[project]/src/app/(application)/checkout/[orderId]/Checkout.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$_service$2f$PaymentService$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/src/app/_service/PaymentService.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$_service$2f$OrderService$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/src/app/_service/OrderService.js [app-client] (ecmascript)"); // Import the new API method
...
const OrderSummary = ({ title, orderId })=>{
    ...
    const userId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$redux$2f$dist$2f$react$2d$redux$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSelector"])({
        "OrderSummary.useSelector[userId]": (state)=>state.userData.user?.id
    }["OrderSummary.useSelector[userId]"]);
    ...
    const phoneNumber = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$redux$2f$dist$2f$react$2d$redux$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSelector"])({
        "OrderSummary.useSelector[phoneNumber]": (state)=>state?.userData?.user?.phone
    ...
    const [totalBill, setTotalBill] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])();
    const token = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$redux$2f$dist$2f$react$2d$redux$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSelector"])({
        "OrderSummary.useSelector[token]": (state)=>state?.userData?.token
    ...
    const fetchOrderData = async ()=>{
        setLoading(true);
        try {
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$_service$2f$OrderService$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchOrderForCheckout"])(orderId);
            console.log(result);
            if (result.status === "success") {
    ...
    const handlePayment = async ()=>{
        ...
        setError(null);
        try {
            const { razorpayOrder, ...data } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$_service$2f$OrderService$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["checkOutOrder"])(orderId);
            const options = {
                ...
                handler: async function(response) {
                    ...
                    try {
                        setLoading(true);
                        const verificationResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$_service$2f$OrderService$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["verifyPaymentAndUpdateOrder"])(orderId, razorpay_order_id, razorpay_payment_id, razorpay_signature);
                        setLoading(false);
                        if (verificationResult.success) {
                            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$js$2d$cookie$2f$dist$2f$js$2e$cookie$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].set("orderId", orderId);
...
_s(OrderSummary, "97SrjnYdZ8jzrgNUg3GP3P3nPoM=", false, function() {
    return [
...
"[project]/src/app/(application)/checkout/[orderId]/page.js [app-rsc] (ecmascript, Next.js server component, client modules)": ((__turbopack_context__) => {
...
//# sourceMappingURL=_b9d6e6._.js.map