(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_app_(application)_df8319._.js", {

"[project]/src/app/(application)/_service/GuestCartService.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f28$application$292f$_service$2f$GuestCartService$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/src/app/(application)/_service/GuestCartService.js [app-client] (ecmascript)");
...
const Cart = ()=>{
                ...
                "Cart.useEffect.loadCart": async ()=>{
                    ...
                    try {
                        if (isLoggedIn) {
                            ...
                            const guestCart = ("TURBOPACK compile-time truthy", 1) ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f28$application$292f$_service$2f$GuestCartService$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getCart"])() : ("TURBOPACK unreachable", undefined);
    ...
    const handleIncreaseQuantity = async (productId, setTileLoading)=>{
        try {
            ...
            if (isLoggedIn) {
                ...
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f28$application$292f$_service$2f$GuestCartService$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["increaseQuantity"])(productId);
                setProducts((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f28$application$292f$_service$2f$GuestCartService$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getCart"])());
            }
        } catch (err) {
    ...
    const handleDecreaseQuantity = async (productId, setTileLoading)=>{
        try {
            ...
            if (isLoggedIn) {
                ...
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f28$application$292f$_service$2f$GuestCartService$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["decreaseQuantity"])(productId);
                setProducts((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f28$application$292f$_service$2f$GuestCartService$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getCart"])());
            }
        } catch (err) {
            setError('Failed to update item quantity. Please try again later.');
    ...
    const handleRemoveProduct = async (productId, setTileLoading)=>{
        try {
            ...
            if (isLoggedIn) {
                ...
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f28$application$292f$_service$2f$GuestCartService$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["removeProduct"])(productId);
                setProducts((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f28$application$292f$_service$2f$GuestCartService$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getCart"])());
            }
        } catch (err) {
    ...
    const handleCheckout = async ()=>{
        ...
        try {
            ...
            const { order } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f28$application$292f$_service$2f$OrderService$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createOrder"])(isLoggedIn.id, items);
            console.log(order);
            const data = {
                orders: order
            };
...
//# sourceMappingURL=src_app_%28application%29_df8319._.js.map