(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_app_62328a._.js", {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$_lib$2f$cartReducer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/src/app/_lib/cartReducer.js [app-client] (ecmascript)"); // Assuming you have a fetchData action
...
const Cart = ()=>{
    ...
    const cookie = JSON.parse(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$js$2d$cookie$2f$dist$2f$js$2e$cookie$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get("shopflow_session"));
    ...
    }["Cart.useSelector"]) || []; // Assuming cart items are stored in Redux
    const totalAmount = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$redux$2f$dist$2f$react$2d$redux$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSelector"])({
        "Cart.useSelector[totalAmount]": (state)=>state?.cart?.length
    }["Cart.useSelector[totalAmount]"]); // Assuming total amount is stored in Redux
                ...
                "Cart.useEffect.loadCart": async ()=>{
                    ...
                    try {
                        if (isLoggedIn) {
                            ...
                            dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$_lib$2f$cartReducer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchData"])(guestCart));
                        }
                    } catch (err) {
    ...
    const handleIncreaseQuantity = async (productId)=>{
        try {
            ...
            dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$_lib$2f$cartReducer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchData"])()); // Dispatch to refresh cart data
        } catch (err) {
...
_s(Cart, "fm4aIeOVwsBrnwRKISHg/GaFOVc=", false, function() {
    return [
...
//# sourceMappingURL=src_app_62328a._.js.map